  ...
  <div className="flex w-full relative">
    <div className="h-17 flex items-center relative">
      ...
      <input
        ...
        className="w-90 h-full pl-10 pr-2 rounded-full text-black-2 placeholder:font-bold placeholder-black-2 border-gray-300 hover:bg-gray-100"
      />
      <button className="absolute right-1 top-1 rounded-full bg-orange-500 hover:bg-orange-600 text-white px-4 py-4"> {/* Adicione as classes necessárias para estilizar o botão como desejado */}
